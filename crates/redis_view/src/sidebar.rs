...
impl RedisSidebar {
    ...
    pub fn ask_ai(&mut self, message: String, cx: &mut Context<Self>) {
        ...
        cx.emit(RedisSidebarEvent::AskAi);
        cx.notify();
    }
    ...
    fn render_toolbar_button(
        ...
        .selected(is_active)
        .tooltip(t!("RedisSidebar.ai_chat").to_string())
...
impl EventEmitter<RedisSidebarEvent> for RedisSidebar {}

impl Focusable for RedisSidebar {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl Render for RedisSidebar {
